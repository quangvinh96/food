$.fn.attachKeyboard = function(options) {
    ...
    var defaults = {
        iconLocation: 'imgs/keyboard_key.png',
        topOffset : -42,
        leftOffset : 20
    };
